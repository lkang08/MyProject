package com.lk.myproject.giftchains;
...
public class CircleProgressView extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mRectLength = (int) ((Math.min(viewWide, viewHigh)) -
                (Math.max(mBackPaint.getStrokeWidth(), mProgPaint.getStrokeWidth())));
        ...
        if (mColorArray != null && mColorArray.length > 1) {
            mProgPaint.setShader(new LinearGradient(getMeasuredWidth() / 2, 0, getMeasuredWidth() / 2,
                    getMeasuredHeight(), mColorArray,
    ...
    public void setProgColor(@ColorRes int startColor, @ColorRes int firstColor) {
        ...
        mProgPaint.setShader(new LinearGradient(size, 0, 0,
                0, mColorArray, null,
