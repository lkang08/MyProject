...
class SendGiftAnimationView @JvmOverloads constructor(
    ...
    fun startGiftAnimation(
        ...
        val initScaleAnimator1 = ObjectAnimator.ofPropertyValuesHolder(
            holder, initScaleX1, initScaleY1,
            initPvhX, initPvhY
        )
        ...
        val initScaleX2 = PropertyValuesHolder.ofFloat(
            "scaleX", minScale,
            minScale * 0.6f
        )
        val initScaleY2 = PropertyValuesHolder.ofFloat(
            "scaleY", minScale,
            minScale * 0.6f
        )
        val initScaleAnimator2 =
        ...
        val startPvhScaleX = PropertyValuesHolder.ofFloat(
            "scaleX",
            minScale * 0.6f, maxScale
        )
        val startPvhScaleY = PropertyValuesHolder.ofFloat(
            "scaleY",
            minScale * 0.6f, maxScale
        )
        val startObjectAnimator = ObjectAnimator.ofPropertyValuesHolder(
            holder, startPvhX, startPvhY,
        ...
        val endPvhScaleX = PropertyValuesHolder.ofFloat(
            "scaleX",
            maxScale, minScale * 0.8f
        )
        val endPvhScaleY = PropertyValuesHolder.ofFloat(
            "scaleY",
            maxScale, minScale * 0.8f
        )
        val endObjectAnimator = ObjectAnimator.ofPropertyValuesHolder(
            holder, endPvhX, endPvhY,
        ...
        val finishScaleX1 = PropertyValuesHolder.ofFloat(
            "scaleX",
            minScale * 0.8f, minScale
        )
        val finishScaleY1 = PropertyValuesHolder.ofFloat(
            "scaleY",
            minScale * 0.8f, minScale
        )
        val finishScaleAnimator1 = ObjectAnimator.ofPropertyValuesHolder(
            holder, finishScaleX1,
            finishScaleY1
        )
        ...
        val finishScaleX2 = PropertyValuesHolder.ofFloat(
            "scaleX",
            minScale, 0.0f
        )
        val finishScaleY2 = PropertyValuesHolder.ofFloat(
            "scaleY",
            minScale, 0.0f
        )
        val finishScaleAnimator2 = ObjectAnimator.ofPropertyValuesHolder(
            holder,
    ...
    override fun dispatchDraw(canvas: Canvas) {
        for (holder in mItems!!) {
            ...
            canvas.scale(
                holder.scaleX, holder.scaleY, holder.view!!.width / 2f,
