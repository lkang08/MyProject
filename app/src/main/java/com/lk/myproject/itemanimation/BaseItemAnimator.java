...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(RecyclerView.ViewHolder oldHolder, ViewHolder newHolder) {
            this.oldHolder = oldHolder;
            this.newHolder = newHolder;
        }

        ChangeInfo(RecyclerView.ViewHolder oldHolder, ViewHolder newHolder,
    ...
    @Override
    public boolean animateChange(RecyclerView.ViewHolder oldHolder, ViewHolder newHolder,
                                 int fromX, int fromY, int toX, int toY) {
     ...
     * <ul>
     * <li>If you override {@link #animateChange(RecyclerView.ViewHolder, ViewHolder, int, int, int, int)}, both
     * ViewHolder arguments will be the same instance.
     * </li>
     * <li>
     * If you are not overriding {@link #animateChange(RecyclerView.ViewHolder, ViewHolder, int, int, int, int)},
